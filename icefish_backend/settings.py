"""
Django settings for icefish_backend project.
...
ALLOWED_HOSTS = ["b195-moo-router.usap.gov", "localhost", '127.0.0.1']
...
ROOT_URLCONF = 'icefish_backend.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'icefish.context_processors.charting_constants',
            ],
        },
    },
]

WSGI_APPLICATION = 'icefish_backend.wsgi.application'
