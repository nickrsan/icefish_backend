ICEFISH_WIPER_SECONDS_PER_REVOLUTION = 9.1;  // measured by Paul and Nick
ICEFISH_WIPER_DEGREES_PER_SECOND = 39.5604;
ICEFISH_WIPER_MS_PER_DEGREE = 25.2777;
ICEFISH_WIPER_BASE_URL = null; // THIS SHOULD BE DEFINED IN PAGE
...
function move_wiper(degrees){
    icefish_wiper_on_off("on");
    setTimeout(icefish_wiper_on_off, ICEFISH_WIPER_MS_PER_DEGREE * degrees);
}